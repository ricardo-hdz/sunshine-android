...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (cursor.moveToFirst()) {
            int rowId = cursor.getColumnIndex(WeatherContract.LocationEntry._ID);
            locationId = cursor.getLong(rowId);
        } else {
            // insert
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                int rows = mContext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI, cVVector.toArray(contentValues));
            }
