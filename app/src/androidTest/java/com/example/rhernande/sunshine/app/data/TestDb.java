 ...
 */
package com.example.rhernande.sunshine.app.data;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        assertTrue("Error: Row id is different of -1", row != -1);
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Unexpected values in location table", c, locationValues);
    ...
    public void testWeatherTable() {
        ...
        // Insert ContentValues into database and get a row ID back
        Long row = db.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, weatherValues);
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: invalid record in weather table", c, weatherValues);
